...
def assert_the_left_edge_tiles_are_solved(left_edge_top: Tile, left_edge_bottom: Tile, diamond: Diamond):
...
def assert_the_right_edge_tiles_are_solved(right_edge_top: Tile, right_edge_bottom: Tile, diamond: Diamond):
